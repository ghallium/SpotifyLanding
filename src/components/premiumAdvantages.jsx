    ...
    <>
        <div className="premium-advantages bg-zinc-900 py-5">
            <div className="text-center text-white py-3">
                <h2 className="text-4xl font-bold mb-2">Vivez la différence</h2>
                <p className="text-2xl w-2/5 m-auto mb-2">Passez à Premium et bénéficiez d'un contrôle total sur votre musique. Annulez à tout moment</p>
            </div>
            <table className="table-fixed text-white m-auto">
                <thead>
                    <tr className="border-b-2 border-white">
                        <th className="w-40">Vos avantages</th>
                        <th className="bg-white text-black w-24 px-3 py-8">Spotify sans abonnement</th>
                        <th className="bg-[#ad2489] w-24 p-3 border-l-2 border-black">Abonnement Spotify Premium</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="h-20 border-b-2 border-white">
